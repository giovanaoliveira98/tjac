tjac_baixar_cjsg <- function(
  ...
  #Requisição
  r <- httr::POST(url = "https://esaj.tjac.jus.br/cjsg/resultadoCompleta.do", body = body, encode = "form")
  ...
  if (tipo == "A") {
    ...
    purrr::walk(percurso, purrr::possibly(~{
      ...
      httr::GET(
        paste0(
          "https://esaj.tjac.jus.br/cjsg/trocaDePagina.do?tipoDeDecisao=A&pagina=",
          .x,
          "&conversationId="),
    ...
    purrr::walk(percurso, purrr::possibly(~{
      ...
      httr::GET(
        paste0(
          "https://esaj.tjac.jus.br/cjsg/trocaDePagina.do?tipoDeDecisao=D&pagina=",
          .x,
          "&conversationId="),
        httr::set_cookies(unlist(r$cookies)),
        httr::accept("text/html; charset=latin1;"),
